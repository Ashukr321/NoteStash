...
import {createNotes,getAllNotes,getNoteById,deleteNote,togglePinNote,toggleStarredNote,addToArchive,updateNote,dashboardStatsData} from './note.controller.js'
import isAuthenticate from '../../middlewares/authMiddleware.js';

// create router 
const router = express.Router();
// routes 
router.get('/dashboard-stats', isAuthenticate, dashboardStatsData);
