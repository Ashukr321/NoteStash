  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-blue-50 via-white to-blue-100 relative px-4">
      ...
      <form
        ...
        className={`w-full max-w-md bg-white/90 rounded-2xl shadow-xl p-8 flex flex-col gap-6 border border-blue-100 transition-all duration-700 ${animate ? 'animate-fadeInUp' : 'opacity-0 translate-y-8'}`}
      >
        <h2 className="text-2xl font-bold text-blue-700 mb-2 text-center">Login to NoteStash</h2>
